<template>
    <b-container fluid class="bg-akf-favourite pb-1 position-relative" style="z-index: 100">
        <b-row align-h="center" align-v="baseline" class="d-none d-md-flex position-relative">
            <div class="c-navbar">
                <a class="c-nav-item" href="https://maktab2030.tj/">{{ $t('label.home_btn') }}</a>
...
.c-navbar .c-nav-item:hover {
    cursor: pointer;
}

.c-navbar .c-nav-item::after {
    content: '';
    position: absolute;
    width: 0px;
    height: 3px;
...
.c-navbar .c-nav-item:hover::after {
    width: 100%;
    left: 0;
}

.c-navbar .active::after {
    content: '';
    position: absolute;
    width: 100%;
    height: 3px;
